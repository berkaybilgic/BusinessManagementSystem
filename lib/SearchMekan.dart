...
class SearchMekan extends StatefulWidget {
  ...
  @override
  _SearchMekanState createState() => _SearchMekanState();
}

class _SearchMekanState extends State<SearchMekan> {
  ...
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      ...
      .where("mekanName", isEqualTo: SearchMekan.query4)
      .snapshots();
