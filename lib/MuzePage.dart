...
class MuzePage extends StatefulWidget {
  @override
  _MuzePageState createState() => _MuzePageState();
}

class _MuzePageState extends State<MuzePage> {
  ...
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      ...
      .where("mekanCategory", isEqualTo: "Müze")
      .snapshots();
