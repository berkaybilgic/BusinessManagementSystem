...
class SinemaPage extends StatefulWidget {
  @override
  _SinemaPageState createState() => _SinemaPageState();
}

class _SinemaPageState extends State<SinemaPage> {
  ...
  final Stream<QuerySnapshot> _usersStream = FirebaseFirestore.instance
      ...
      .where("mekanCategory", isEqualTo: "Sinema")
      .snapshots();
